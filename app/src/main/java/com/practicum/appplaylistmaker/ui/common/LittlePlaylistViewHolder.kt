...
class LittlePlaylistViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
    private val playlistName: TextView
    private val soundImage: ImageView
    private val tracksCountInPlaylist: TextView

    init {
        playlistName = itemView.findViewById(R.id.playlist_name_little)
        soundImage = itemView.findViewById(R.id.playlist_little_image)
        tracksCountInPlaylist = itemView.findViewById(R.id.tracks_count_little)
    }
